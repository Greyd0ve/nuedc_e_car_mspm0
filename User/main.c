...
#if ECAR_AIM_LINK_TEST_MODE || ECAR_GIMBAL_STEP_TEST_MODE || ECAR_VISUAL_GIMBAL_X_TEST_MODE || ECAR_VISUAL_GIMBAL_XY_TEST_MODE
...
#if !ECAR_GIMBAL_STEP_TEST_MODE && !ECAR_AIM_LINK_TEST_MODE && !ECAR_VISUAL_GIMBAL_X_TEST_MODE && !ECAR_VISUAL_GIMBAL_XY_TEST_MODE
        if (taskCount > 0U)
        {
